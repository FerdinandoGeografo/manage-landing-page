    ...
    <footer class="footer">
      <div class="container footer__content">
        ...
        <form class="footer__form" [formGroup]="form">
          ...
          />
          <span
            class="footer__input-error"
            [ngClass]="{
              'footer__input-error--shown':
        ...
        <ul class="footer__icons">
          <li>
            <a
              class="footer__icon"
              href="#"
              aria-label="Visit Manage profile on Facebook!"
            >
              <svg
          ...
          <li>
            <a
              class="footer__icon"
              href="#"
              aria-label="Visit Manage profile on Youtube!"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="21"
          ...
          <li>
            <a
              class="footer__icon"
              href="#"
              aria-label="Visit Manage profile on Twitter!"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="21"
          ...
          <li>
            <a
              class="footer__icon"
              href="#"
              aria-label="Visit Manage profile on Pinterest!"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
          ...
          <li>
            <a
              class="footer__icon"
              href="#"
              aria-label="Visit Manage profile on Instagram!"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="21"
      ...
      <div class="attribution heading heading--sm">
        <p>
          Coded by
          <a class="attribution__link" href="https://www.linkedin.com/in/ferdinandogeografo/" target="_blank"> Ferdinando Geografo </a>
          .
        </p>
        <p>
          Check my projects on my
          <a class="attribution__link" href="https://github.com/FerdinandoGeografo/" target="_blank"> Git Hub </a>
          .
        </p>
      </div>
    </footer>
