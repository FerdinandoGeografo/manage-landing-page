  ...
  template: `
    <footer class="footer">
      <div class="container footer__content">
        <img class="footer__logo" src="images/logo-white.svg" alt="Manage footer logo" />
        ...
        <form class="footer__form" [formGroup]="form">
          <input
            class="heading heading--sm footer__input"
            type="email"
            placeholder="Updates in your inbox..."
            formControlName="email"
          />
          <span class="footer__input-error" [ngClass]="{ 'footer__input-error--shown' : form.controls.email.dirty && form.controls.email.invalid }">Please insert a valid email</span>
          <button app-button class="footer__btn" styleClass="btn--shadow-none">
            Go
          </button>
        </form>
        ...
        <ul class="footer__icons">
          <li>
            <a class="footer__icon" href="#" aria-label="Visit Manage profile on Facebook!">
          ...
          <li>
            <a class="footer__icon" href="#" aria-label="Visit Manage profile on Youtube!">
          ...
          <li>
            <a class="footer__icon" href="#" aria-label="Visit Manage profile on Twitter!">
          ...
          <li>
            <a class="footer__icon" href="#" aria-label="Visit Manage profile on Pinterest!">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">
                <path
                  fill="currentColor"
          ...
          <li>
            <a class="footer__icon" href="#" aria-label="Visit Manage profile on Instagram!">
              <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20">
                <path
                  fill="currentColor"
        ...
        <p class="heading heading--sm footer__copyright">
